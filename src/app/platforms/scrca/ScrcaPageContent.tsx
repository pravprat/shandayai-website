...
const runtimeRcaFeatures = [
  "Parse Spark driver, executor, and event logs in place",
  "Parse JVM GC and Kubernetes pod/container logs",
  "Normalize into canonical runtime events and incident windows",
  "Generate evidence-backed RCA summaries and escalation packets",
  "Customer-hosted Docker deployment — raw logs stay in your boundary",
];
      ...
      <div className="relative">
        ...
        <div className="space-y-4">
          {platformLayers.map((layer, index) => (
            <div
              key={layer.label}
              className="group relative rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur"
            >
        ...
        {workflow.map((item, index) => (
          <div key={item} className="relative">
            <div className="flex min-h-28 flex-col justify-between rounded-2xl border border-white/10 bg-slate-900/80 p-4 transition hover:border-cyan-300/40 hover:bg-slate-900">
              <div className="text-xs font-medium uppercase tracking-widest text-cyan-300">
                0{index + 1}
              </div>
      ...
      <div className="relative">
        <div className="mb-8 max-w-3xl">
          ...
          <p className="mt-4 text-slate-400">
            Agents coordinate the workflow, deterministic RCA identifies the cause, CI/CD
            connects the cause to change, and humans approve bounded remediation before execution.
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white">
      ...
      <main>
        ...
        <section id="runtime-rca" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
                Customer-hosted support escalation intelligence.
              </h2>
              <p className="mt-6 text-lg leading-8 text-slate-400">
                A private Runtime RCA service that runs inside your environment, reads logs in
                place, and produces evidence-backed RCA reports and support escalation packets.
                Raw logs do not leave your boundary.
              </p>
              <p className="mt-4 text-sm text-slate-500">
                First vertical: Spark / JVM / Kubernetes runtime RCA.
              </p>
            </div>
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-8">
              <div className="mb-6 inline-flex rounded-2xl bg-cyan-300/10 p-3 text-cyan-300 ring-1 ring-cyan-300/20">
                <Container className="h-6 w-6" />
              </div>
              <ul className="space-y-4">
                {runtimeRcaFeatures.map((feature) => (
        ...
        <section id="platform" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-400">
                Generic agents can summarize information, but infrastructure operations require
                stronger guarantees: clear context, deterministic diagnostics, evidence-linked
                reasoning, policy-aware workflows, and human approval before risky actions.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              {capabilities.map((item) => (
                <div
                  key={item.title}
                  className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 hover:border-cyan-300/30"
                >
        ...
        <section id="architecture" className="border-y border-white/10 bg-white/[0.02]">
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1fr_1fr] lg:items-center lg:px-8">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-400">
                SCRCA separates orchestration from reasoning. Agents coordinate workflows and
                tools. Semantic intelligence grounds context. Deterministic RCA computes the
                cause. Governance controls actions.
              </p>
              <div className="mt-8 space-y-4">
                {[
                  "Agents coordinate",
                  "Semantic context grounds",
                  "Deterministic RCA diagnoses",
        ...
        <section id="workflow" className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-400">
              The platform turns alerts into scoped context, invokes deterministic analysis,
              correlates changes, routes approvals, and verifies outcomes.
            </p>
          </div>
          <WorkflowVisual />
        </section>
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-slate-400">
                  Infrastructure automation cannot rely on opaque guesses. SCRCA is designed
                  around explainability, validation, auditability, and controlled progression
              ...
              <div className="space-y-4">
                {[
                  [
                    ...
                    "Claims should trace back to logs, clusters, events, and time windows.",
                  ],
                  [
                    "Human-in-the-loop approval",
                    "Risky actions require explicit authorization before execution.",
                  ],
                  [
                    "Policy-aware automation",
                    "Actions are classified by blast radius, reversibility, and operational risk.",
                  ],
                  [
                    "Feedback-driven learning",
                    "Outcomes are captured to improve playbooks, patterns, and future diagnosis.",
                  ],
                ].map(([title, desc]) => (
                  <div
                    key={title}
